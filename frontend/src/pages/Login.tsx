        ...
        <div className="max-w-md mx-auto">
          <div className="tv-card">
            <div className="text-center mb-8">
              ...
              <p className="text-tv-text-secondary">Masuk ke akun AkuRajaCrypto Anda</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-tv-text-secondary text-sm">Remember me</span>
                </label>
                <Link to="/forgot-password" className="text-tv-blue text-sm hover:underline">
                  Lupa password?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-tv-text-secondary">
                Belum punya akun?{' '}
                <Link to="/register" className="text-tv-blue hover:underline">
                  Daftar di sini
                </Link>
              </p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-tv-border">
              <div className="text-center mb-4">
                <span className="text-tv-text-secondary text-sm">Atau masuk dengan</span>
              </div>
